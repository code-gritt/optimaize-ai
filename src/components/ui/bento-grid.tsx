...
export const CARDS = [
  {
    Icon: Link2Icon,
    name: "Optimize Links",
    description: "Shorten and optimize your links for maximum engagement.",
    href: "#",
    cta: "Discover more",
    ...
    background: (
      <Card className="absolute top-10 left-10 origin-top rounded-none rounded-tl-md transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_0%,#000_100%)] group-hover:scale-105 border border-border border-r-0">
        <CardHeader>
          <CardTitle>Optimize Links</CardTitle>
          <CardDescription>
            Easily shorten and customize links while tracking performance.
          </CardDescription>
        </CardHeader>
  ...
  },
  {
    ...
    name: "AI Link Search",
    description:
      "Find and analyze your links instantly using AI-powered search.",
    href: "#",
    cta: "Discover more",
  ...
  },
  {
    ...
    description: "Connect OptimAIzer with your favorite apps seamlessly.",
    href: "#",
    cta: "Discover more",
  ...
  },
  {
    ...
    description:
      "Visualize your link activity and campaigns in one calendar view.",
    className: "col-span-3 lg:col-span-1",
    href: "#",
    cta: "Discover more",
    background: (
      <Calendar
        mode="single"
        selected={new Date(2024, 9, 5, 0, 0, 0)}
